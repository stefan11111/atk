...
#define ATK_PLUG(obj)               (obj)
#define ATK_IS_PLUG(obj)            0
#define ATK_PLUG_CLASS(klass)       (klass)
#define ATK_IS_PLUG_CLASS(klass)    0
#define ATK_PLUG_GET_CLASS(obj)     (*(void**)(obj))
